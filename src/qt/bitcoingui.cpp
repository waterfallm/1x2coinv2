                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1x2coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1X2_COIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 1x2coin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1x2coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1x2coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1x2coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1X2_COIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1X2_COIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a 1x2coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 1x2coin Core help message to get a list with possible 1x2coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1x2coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1x2coin network", "", count));
}
...
{
    QString strTitle = tr("1x2coin Core"); // default title
