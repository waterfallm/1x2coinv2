...
// 1X2_COIN: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // 1X2_COIN: add to spork database.
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
		...
		if (nSporkID == SPORK_17_STAKE_REQ_AG) r = SPORK_17_STAKE_REQ_AG_DEFAULT;
		if (nSporkID == SPORK_18_STAKE_REQ_SZ) r = SPORK_18_STAKE_REQ_SZ_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
	...
	if (strName == "SPORK_17_STAKE_REQ_AG") return SPORK_17_STAKE_REQ_AG;
	if (strName == "SPORK_18_STAKE_REQ_SZ") return SPORK_18_STAKE_REQ_SZ;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
	...
	if (id == SPORK_17_STAKE_REQ_AG) return "SPORK_17_STAKE_REQ_AG";
	if (id == SPORK_18_STAKE_REQ_SZ) return "SPORK_18_STAKE_REQ_SZ";
