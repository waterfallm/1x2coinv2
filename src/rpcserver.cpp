...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "1x2coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 1x2coin features */
        {"1x2coin", "masternode", &masternode, true, true, false},
        {"1x2coin", "listmasternodes", &listmasternodes, true, true, false},
        {"1x2coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"1x2coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"1x2coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"1x2coin", "masternodedebug", &masternodedebug, true, true, false},
        {"1x2coin", "startmasternode", &startmasternode, true, true, false},
        {"1x2coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"1x2coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"1x2coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"1x2coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"1x2coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"1x2coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"1x2coin", "mnbudget", &mnbudget, true, true, false},
        {"1x2coin", "preparebudget", &preparebudget, true, true, false},
        {"1x2coin", "submitbudget", &submitbudget, true, true, false},
        {"1x2coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"1x2coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"1x2coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"1x2coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"1x2coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"1x2coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"1x2coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"1x2coin", "checkbudgets", &checkbudgets, true, true, false},
        {"1x2coin", "mnsync", &mnsync, true, true, false},
        {"1x2coin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> 1x2coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9213/\n";
}
