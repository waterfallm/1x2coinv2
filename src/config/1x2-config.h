/* src/config/1x2coin-config.h.  Generated from 1x2coin-config.h.in by configure.  */
/* src/config/1x2coin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef X12_COIN_CONFIG_H

#define X12_COIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://1x2-coin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "1X2COIN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "1X2COIN Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "1X2COIN"
