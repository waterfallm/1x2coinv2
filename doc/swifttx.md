...
This mechanism has been integrated into Bitcore-Node-1x2coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/1x2coin/insight-api-1x2coin#web-socket-api](https://github.com/1x2coin/insight-api-1x2coin#web-socket-api)
* API: [https://github.com/1x2coin/insight-api-1x2coin#swifttx-transactions](https://github.com/1x2coin/insight-api-1x2coin#swifttx-transactions)
...
By default, the 1x2coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the 1x2coin Core daemon:
