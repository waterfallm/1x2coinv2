...
Intro
-----
1x2coin (1X2_COIN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. 1x2coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run 1x2coin-qt.exe.

1x2coin Core is the original 1x2coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of 1x2coin transactions;
