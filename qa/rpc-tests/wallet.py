...
#   c) node1 mines 32 blocks, so now node 0 has 5000001X2_COIN, node 1 has 42501X2_COIN, node2 has none.
#   d) node0 sends 601 1X2_COIN to node2, in two transactions (301 1X2_COIN, then 300 1X2_COIN).
